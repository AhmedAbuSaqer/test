...
function cta_clicked () {
    console.log("Spin Clicked");
}

$(window).ready(function() {
    $(function(){
        // On user selection this will be called
    ...
    function form_submit() {
        ...
        var question_1_answer = document.getElementById("question_1_answer").value;
        var question_2_answer = document.getElementById("question_2_answer").value;
        var gender = document.getElementById("gender").value;
        var age_range = document.getElementById("age_range").value;
        var list = getURLParam_default('list', 'YL8x6n763fjTSstEdYSST1wA');
        ...
        if ( email && validateEmail(email) ){
            var formData = {
                ...
                "Gender": gender,
                "Age": age_range,
                "Q1": question_1_answer,
                "Q2": question_2_answer,
                "Lander": "CAS-07-GL-01-EN-OPT",
                "hp": "",
                "list": list,
                "subform": "yes"
            };
            ...
            $.ajax({
                url: "https://sendy.jolly-goodies.com/subscribe",
                type: "post",
                dataType: "json",
                crossDomain: true,
                data: formData,
            ...
            // var cid = getURLParam_default('cid', 'Unknown');
            // var postback_url = 'https://track.umtrck.com/postback?cid=' + cid + '&et=email&txid=email';
            // fetch(postback_url);
            // console.log("Fire Conversion:", postback_url);
        } else {
    ...
    $("#BtnCopy").click(function() {
        console.log("Clicked button to copy code");
        $(this).text("COPIED");
        setTimeout(function(){ $("#BtnCopy").text("COPY COUPON");}, 1500);
        TweenMax.to("#Ccode", 0.5, {backgroundColor:"#ffffff", color:"#ac0101",scale:1.05, ease:Power3.easeOut, yoyo:true, repeat:1});
    });
    var Ccode_Top = new ClipboardJS("#BtnCopy", { text: function() { return "CABIN777"; } });
});
...
$(window).ready(function() {
    $('.allow').text('Click ALLOW to claim your Free Spins!');
    $('.spin-trigger').text('SPIN ME');
    $('.popup_grey_info').text('Click Claim Now to get your 55 Free Spins');
    $('.copy-code').replaceWith('<p class="copy-code">Copy the coupon code below, then click Continue to claim your FREE Spins!</p>');
});
...
var base_url = getURLParam_default('domain', 'track.umtrck.com');
var back_url = 'back.html?domain=' + base_url; // back button url
